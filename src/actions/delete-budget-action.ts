...
export async function deleteBudget(
  ...
  const checkPasswordUrl = `${process.env.NEXT_PUBLIC_API_URL}/api/auth/check-password`;
  ...
  const deleteBudgetUrl = `${process.env.NEXT_PUBLIC_API_URL}/api/budgets/${budgetId}`;
