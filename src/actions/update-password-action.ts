...
import { ErrorResponseSchema, SuccessSchema, UpdatePasswordSchema } from "@/schemas";
...
export async function updatePassword(
  ...
  const url = `${process.env.NEXT_PUBLIC_API_URL}/api/auth/update-password`;
  ...
  const succes = SuccessSchema.parse(json);
